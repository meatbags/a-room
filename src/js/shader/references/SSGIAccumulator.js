...
class SSGIAccumulatorNode extends TempNode {

	static get type() {

		return 'SSGIAccumulatorNode';
	...
	constructor( beautyNode, depthNode, velocityNode, camera ) {
		 ...
		 * @default true
		 */
		this.isSSGIAccumulatorNode = true;
		...
		this._historyRenderTarget.texture.name = 'SSGIAccumulatorNode.history';
		...
		this._resolveRenderTarget.texture.name = 'SSGIAccumulatorNode.resolve';
		...
		this._resolveMaterial.name = 'SSGIAccumulator.resolve';
...
export default SSGIAccumulatorNode;
 ...
 * @param {TextureNode} velocityNode - A node that represents the scene's velocity.
 * @param {Camera} camera - The camera the scene is rendered with.
 * @returns {SSGIAccumulatorNolde}
 */
export const ssgiAccumulator = ( beautyNode, depthNode, velocityNode, camera ) => 
  nodeObject( new SSGIAccumulatorNode( convertToTexture( beautyNode ), depthNode, velocityNode, camera ) );